...
public interface LawyerRepository extends JpaRepository<Lawyer, Long> {
	...
	/* Observação:
	JPQL não tem o UNION, utilizado apenas o nativeQuery.
	Acho que não vale o esforço de reescrever
	a consulta no JPQL, na tentativa de montar uma forma equivalente ao UNION.
	*/	
}
